...
for ii = 1:numel(sub_dirs)
    ...
    mu = load(['tracks_sift2_weights_ss3t_' sub '_50M_prop_coeff.txt']); % Subject-specific proportionality coefficient generated by SIFT2
    ...
    for jj = 1:numel(rois)
        ...
        if strcmp(r(1),'.') % Skip files starting with .
            continue
        elseif strcmp(r,'Dp-Da.rh') || strcmp(r,'Lp-La.rh') % Skip these ROIs
            continue
        end
        tck = ['tracks_ss3t_' sub '_50M_' r];
        tck_weights = ['tracks_sift2_weights_ss3t_' sub '_50M_' r '.txt'];
