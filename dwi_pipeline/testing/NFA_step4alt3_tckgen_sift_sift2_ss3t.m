...
%         
    ...
    unix(['tcksift2 tracks_ss3t_' sub '_combined.tck'...
         ' fod_wm_norm.mif.gz tracks_sift2_weights_ss3t_' sub '_combined_nofdscale.txt'...
         ' -act aseg_5ttgen.mif.gz -info '...
         ' -out_mu tracks_sift2_weights_ss3t_' sub '_combined_nofdscale_prop_coeff.txt']);
    ...
    for jj = 1:numel(rois)
        ...
        unix(['tckedit -force tracks_ss3t_' sub '_combined.tck -ends_only'...
            ' -tck_weights_in tracks_sift2_weights_ss3t_' sub '_combined_nofdscale.txt'...
            ' -tck_weights_out tracks_sift2_weights_ss3t_' sub '_combined_nofdscale_' r(1:8) '.txt'...
            ' -include ' r(1:8) '.binary_vol_al2dwi.nii.gz '...
            ' tracks_ss3t_' sub '_combined_nofdscale_' r(1:8) '.tck']);
    end
