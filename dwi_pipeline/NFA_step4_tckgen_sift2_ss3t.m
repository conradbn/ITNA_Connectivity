...
for ii = 1:numel(sub_dirs)
    ...
    unix(['tcksift2 tracks_ss3t_' sub '_combined.tck'...
         ' fod_wm_norm.mif.gz tracks_sift2_weights_ss3t_' sub '_combined_rerun.txt'...
    ...
    for jj = 1:numel(rois)
        ...
        unix(['tckedit -force tracks_ss3t_' sub '_combined.tck -ends_only'...
            ' -tck_weights_in tracks_sift2_weights_ss3t_' sub '_combined.txt'...
            ' -tck_weights_out tracks_sift2_weights_ss3t_' sub '_combined_' r(1:8) '.txt'...
            ' -include ' r(1:8) '.binary_vol_al2dwi.nii.gz '...
            ' tracks_ss3t_' sub '_combined_' r(1:8) '.tck']);
    end
