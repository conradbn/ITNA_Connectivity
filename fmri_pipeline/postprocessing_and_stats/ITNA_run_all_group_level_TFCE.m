...
input_strings = {
    ...
    'GroupMask_DigLH_LetLH_consistency_thresh_0.3_lh_PLUS.niml.dset',...
    ...
    'GroupMask_DigLH_DigRH_consistency_thresh_0.3_lh_PLUS.niml.dset',...
        'AllSubs_tracks_ss3t_50M_Dp-Da.lh.TDI_ends.norm.al2anat.lh.6mm.log+c.niml.dset',...
...
%         'AllSubs_tracks_ss3t_50M_Dp-Da_math.rh.TDI_ends.norm.al2anat.rh.6mm.log+c.niml.dset';
    ...
    'GroupMask_DigLH_LetLH_consistency_thresh_0.3_rh_PLUS.niml.dset',...
        'AllSubs_tracks_ss3t_50M_Dp-Da.lh.TDI_ends.norm.al2anat.rh.6mm.log+c.niml.dset',...
        'AllSubs_tracks_ss3t_50M_Lp-La.lh.TDI_ends.norm.al2anat.rh.6mm.log+c.niml.dset';
        
    'PairedTest_SC_DigLH_vs_DigRH_log+c_on_LHsurf_contra','rh','ld141',...
    'GroupMask_DigLH_DigRH_consistency_thresh_0.3_rh_PLUS.niml.dset',...
        'AllSubs_tracks_ss3t_50M_Dp-Da.lh.TDI_ends.norm.al2anat.rh.6mm.log+c.niml.dset',...
        'AllSubs_tracks_ss3t_50M_Dp-Da_math.rh.TDI_ends.norm.al2anat.lh.6mm.log+c_MAP2CON.niml.dset';
...
%     '',...
%         'AllSubs_Dp-Da_math.rh.beta_series_corr.lh.Zmap.Dp.niml.dset',...
%         'AllSubs_Dp-Da_math.rh.beta_series_corr.lh.Zmap.Da.niml.dset';      
        
%     'PairedTest_FC_ALL_DigLH_vs_DigRH_on_LHsurf_contra','rh','ld60',...
%     '',...
%         'AllSubs_Dp-Da.lh.beta_series_corr.rh.Zmap.ALL.niml.dset',...
%         'AllSubs_Dp-Da_math.rh.beta_series_corr.lh.Zmap.ALL_MAP2CON.niml.dset';   
    
%     'PairedTest_FC_Dp-Da_DigLH_vs_DigRH_on_LHsurf_contra','rh','ld60',...
%     '',...
%         'AllSubs_Dp-Da.lh.beta_series_corr.rh.Zdiff.Dp-Da.niml.dset',...
%         'AllSubs_Dp-Da_math.rh.beta_series_corr.lh.Zdiff.Dp-Da_MAP2CON.niml.dset'
...
for ii = 1:size(input_strings,1)
    ...
    if contains(label,'PairedTest_SC')
        ...
        % thresholding)
        mask_dset2 = strrep(mask_dset,'DigLH','DigLH_CONJ');
        if ~exist(mask_dset2,'file') % Check for different mask naming convention
            mask_dset2 = strrep(mask_dset,'plus','CONJ');
            mask_dset2 = strrep(mask_dset2,'PLUS','CONJ');
        end
        mask_dset = mask_dset2;
    ...
    if ~isempty(mask_dset)
        ds_mask = afni_niml_readsimple(['/Users/nbl_imac2/Documents/GitHub/ITNA_Connectivity/roi_creation/rois/' mask_dset]);
