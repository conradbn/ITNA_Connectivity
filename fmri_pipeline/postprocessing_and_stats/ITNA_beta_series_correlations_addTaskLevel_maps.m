...
%         b = afni_niml_readsimple(betas);
        ...
        for ss = 1:numel(seed)
            ...
            % ***** SWITCH HEMI SETTING BASED ON SEED *******
            if strcmp(s,'Dp-Da') || strcmp(s,'Lp-La')
                h = 'lh';
...
%                     idx = events == ee & events_censor == 0;
                    ...
                    % ******* GET INDEX OF ALL TRIALS FOR EACH TASK ********
                    if strcmp(e,'ALL_DTask')
                         idx = (events == 1 | events == 3) & events_censor == 0;
                    elseif strcmp(e,'ALL_LTask')
                         idx = (events == 2 | events == 4) & events_censor == 0;
                    end
                    % ******************************************************
