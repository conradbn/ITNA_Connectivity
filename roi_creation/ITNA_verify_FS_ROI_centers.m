...
%% Convert to NIML
cd(out_dir);
unix(['ConvertDset -pad_to_node ld60 -o_niml '...
     ' -node_index_1D FS_lh_centers.inflated.5mm_diam.1.1D[0]'...
     ' -input FS_lh_centers.inflated.5mm_diam.1.1D[1]'...
     ' -prefix FS_lh_centers.inflated.5mm_diam']);
 
 unix(['ConvertDset -pad_to_node ld60 -o_niml '...
     ' -node_index_1D FS_rh_centers.inflated.5mm_diam.1.1D[0]'...
     ' -input FS_rh_centers.inflated.5mm_diam.1.1D[1]'...
     ' -prefix FS_rh_centers.inflated.5mm_diam']);